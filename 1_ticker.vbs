...
'Write code for #1 of assignment: Ticker symbol
    ...
    '(TickerName has to be placed in the TickerList_Row)

    'Loop through rows in the original ticker column: Write a for loop to meet condition
    'that if next cell is not the same as previous cell,
    'then print the value of previous cell in the ticker symbol list column
